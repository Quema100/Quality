function YoutubeDownloader(app,fs,path,os,spawn){
    ...
    let users = {};
    app.route('/signin/contents/YoutubeDownloader')
    .get((req, res) => {
    ...
    .post((req, res) => {
        const userID = req.query.userID;
        const batchFilePath = path.join(__dirname,'.','python','YouTube','YouTube-Video-Downloader.bat')
