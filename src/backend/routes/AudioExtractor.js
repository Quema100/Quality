function AudioExtractor(app,fs,path,os,spawn){
    ...
    let users = {};
    app.route('/signin/contents/AudioExtractor')
    .get((req, res) => {
    ...
    .post((req, res) => {
        const userID = req.query.userID;
        const batchFilePath = path.join(__dirname,'.','python','YouTube','Audio-Extractor.bat')
